package com.alialtunoglu.bdchat.Adapter;
...
public class ChatAdapter extends RecyclerView.Adapter{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Gelen ve giden mesaj olarak iki xml dosyasınıda türüne göre bağladık
    ...
    public int getItemViewType(int position) {
        //Mesaj uygulamaya şuan giriş yapan kullanıcı tarafından gönderildiyse SENDER WİEW TYPE DÖNDÜR
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        //Burada mesajı sildirme işlemlerini yapıyoruz
        ...
        if(holder.getClass() == SenderViewHolder.class){
            //Burayı anlamadım buraya bir bak.
            //Burada mesaj gönderme ve zamanı gösterme işlemlerini yapıyoruz
